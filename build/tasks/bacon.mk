...
bacon: $(INTERNAL_OTA_PACKAGE_TARGET)
	...
	@echo -e ${CL_CYN}"  ___ ___ _______ _______ _______  ___ _______ _______ "${CL_CYN}
	@echo -e ${CL_CYN}" |   Y   |   _   |   _   |   _   \|   |   _   |   _   |"${CL_CYN}
	@echo -e ${CL_CYN}" |.      |.  |   |.  l   |.  1   /|.  |.  |   |   1___|"${CL_CYN}
	@echo -e ${CL_CYN}" |. \_/  |.  |   |.  _   |.  _   \|.  |.  |   |____   |"${CL_CYN}
	@echo -e ${CL_CYN}" |:  |   |:  1   |:  |   |:  1    |:  |:  1   |:  1   |"${CL_CYN}
	@echo -e ${CL_CYN}" |::.|:. |::.. . |::.|:. |::.. .  |::.|::.. . |::.. . |"${CL_CYN}
	@echo -e ${CL_CYN}" `--- ---`-------`--- ---`-------'`---`-------`-------'"${CL_CYN}
	@echo -e ${CL_CYN}""${CL_CYN}
	...
	@echo -e ${CL_CYN}"===================-Enjoy PLOX-==================="${CL_RST}
	@echo -e ""
